...
/**
 * FlatErrorResponse Class Doc Comment
 *
 * @category    Class
 * @package     Flat\APIClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FlatErrorResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlatErrorResponse';
    ...
    /**
     * Sets code
     * @param string $code A corresponding code for this error
     * @return $this
     */
    ...
    /**
     * Sets message
     * @param string $message A printable message for this message
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string $id An unique error identifier generated for the request
     * @return $this
     */
    ...
    /**
     * Sets param
     * @param string $param The related parameter that caused the error
     * @return $this
     */
