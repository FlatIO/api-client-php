 ...
 *
 * @category    Class
 * @description A computed version of the total, weekly, and monthly number of views of the score
 * @package     Flat\APIClient
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScoreViewsCounts implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoreViewsCounts';
    ...
    /**
     * Sets total
     * @param float $total The total number of views of the score
     * @return $this
     */
    ...
    /**
     * Sets weekly
     * @param float $weekly The weekly number of views of the score
     * @return $this
     */
    ...
    /**
     * Sets monthly
     * @param float $monthly The monthly number of views of the score
     * @return $this
     */
