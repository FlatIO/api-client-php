 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScoreCommentContext implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['partUuid'] === null) {
            $invalid_properties[] = "'partUuid' can't be null";
        }
        if ($this->container['staffIdx'] === null) {
            $invalid_properties[] = "'staffIdx' can't be null";
        }
        if ($this->container['measureUuids'] === null) {
            $invalid_properties[] = "'measureUuids' can't be null";
        }
        if ($this->container['startTimePos'] === null) {
            $invalid_properties[] = "'startTimePos' can't be null";
        }
        if ($this->container['stopTimePos'] === null) {
            $invalid_properties[] = "'stopTimePos' can't be null";
        }
        if ($this->container['startDpq'] === null) {
            $invalid_properties[] = "'startDpq' can't be null";
        }
        if ($this->container['stopDpq'] === null) {
            $invalid_properties[] = "'stopDpq' can't be null";
        }
