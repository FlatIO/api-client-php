 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScoreSource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoreSource';
    ...
    /**
     * Sets googleDrive
     * @param string $googleDrive If the score is a file on Google Drive, this field property must contain its identifier. To use this method, the Drive file must be public or the Flat Drive App must have access to the file.
     * @return $this
     */
