 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScoreRevisionStatistics implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoreRevisionStatistics';
    ...
    /**
     * Sets additions
     * @param float $additions The number of additions operations in the last revision
     * @return $this
     */
    ...
    /**
     * Sets deletions
     * @param float $deletions The number of deletions operations in the last revision
     * @return $this
     */
