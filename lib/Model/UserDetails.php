 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UserDetails extends UserPublic implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'type', must be one of 'user', 'guest'.";
        }
    ...
    {
        $allowed_values = array('user', 'guest');
        if (!is_null($type) && (!in_array($type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'user', 'guest'");
        }
