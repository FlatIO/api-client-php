...
/**
 * ScoreCommentsCounts Class Doc Comment
 *
 * @category    Class
 * @description A computed version of the total, unique, weekly and monthly number of comments added on the documents (this doesn&#39;t include inline comments).
 * @package     Flat\APIClient
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScoreCommentsCounts implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoreCommentsCounts';
    ...
    /**
     * Sets total
     * @param float $total The total number of comments added on the score
     * @return $this
     */
    ...
    /**
     * Sets unique
     * @param float $unique The unique (1/user) number of comments added on the score
     * @return $this
     */
    ...
    /**
     * Sets weekly
     * @param float $weekly The weekly unique number of comments added on the score
     * @return $this
     */
    ...
    /**
     * Sets monthly
     * @param float $monthly The monthly unique number of comments added on the score
     * @return $this
     */
