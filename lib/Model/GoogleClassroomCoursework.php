 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GoogleClassroomCoursework implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GoogleClassroomCoursework';
     ...
     * Sets id
     *
     * @param string $id Identifier of the coursework assigned by Classroom
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state State of the coursework
     *
     * @return $this
     */
