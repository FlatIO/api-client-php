 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScoreCommentUpdate implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['comment']) && (strlen($this->container['comment']) > 10000)) {
            $invalid_properties[] = "invalid value for 'comment', the character length must be smaller than or equal to 10000.";
        }

        if (!is_null($this->container['comment']) && (strlen($this->container['comment']) < 1)) {
            $invalid_properties[] = "invalid value for 'comment', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['rawComment']) && (strlen($this->container['rawComment']) > 10000)) {
            $invalid_properties[] = "invalid value for 'rawComment', the character length must be smaller than or equal to 10000.";
        }

        if (!is_null($this->container['rawComment']) && (strlen($this->container['rawComment']) < 1)) {
            $invalid_properties[] = "invalid value for 'rawComment', the character length must be bigger than or equal to 1.";
        }
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['comment']) > 10000) {
            return false;
        }
        if (strlen($this->container['comment']) < 1) {
            return false;
        }
        if (strlen($this->container['rawComment']) > 10000) {
            return false;
        }
        if (strlen($this->container['rawComment']) < 1) {
            return false;
        }
        return true;
    }
    ...
    /**
     * Sets revision
     * @param string $revision The unique indentifier of the revision of the score where the comment was added
     * @return $this
     */
    ...
    {
        if (!is_null($comment) && (strlen($comment) > 10000)) {
        ...
        if (!is_null($comment) && (strlen($comment) < 1)) {
    ...
    {
        if (!is_null($rawComment) && (strlen($rawComment) > 10000)) {
        ...
        if (!is_null($rawComment) && (strlen($rawComment) < 1)) {
