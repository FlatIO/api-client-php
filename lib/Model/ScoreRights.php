 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ScoreRights implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoreRights';
    ...
    /**
     * Sets aclWrite
     * @param bool $aclWrite `True` if the current user can modify the current document
     * @return $this
     */
    ...
    /**
     * Sets aclAdmin
     * @param bool $aclAdmin `True` if the current user can manage the current document, i.e. changing the document permissions and deleting the document
     * @return $this
     */
