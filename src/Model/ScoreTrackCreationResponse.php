...
/**
 * ScoreTrackCreationResponse Class Doc Comment
 *
 ...
 */
class ScoreTrackCreationResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ScoreTrackCreationResponse';
    ...
    protected static array $openAPITypes = [
        'track' => '\Flat\APIClient\Model\ScoreTrack'
    ];
     ...
     */
    public function getTrack(): \Flat\APIClient\Model\ScoreTrack
    {
     ...
     * Sets track
     *
     * @param \Flat\APIClient\Model\ScoreTrack $track track
     *
     * @return $this
     */
    public function setTrack(\Flat\APIClient\Model\ScoreTrack $track): static
    {
        if (is_null($track)) {
