...
/**
 * OmrJobResult Class Doc Comment
 *
 * @description The outcome of a finished job. Present when &#x60;status&#x60; is &#x60;done&#x60;.
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class OmrJobResult implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'OmrJobResult';
     ...
     * Sets score
     *
     * @param string|null $score Created score ID, when `output` is `library`.
     *
     * @return $this
     */
     ...
     * Sets exports
     *
     * @param string[]|null $exports Formats available via `getOmrJobExport`, for example `[\"musicxml\", \"mxl\", \"midi\"]`.
     *
     * @return $this
     */
