...
/**
 * ScoreCommentModeration Class Doc Comment
 *
 ...
 */
class ScoreCommentModeration implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ScoreComment_moderation';
     ...
     * Sets hidden
     *
     * @param bool|null $hidden If true, this comment will be hidden from other users
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string|null $reason If the comment is hidden, the reason why this one has been moderated
     *
     * @return $this
     */
