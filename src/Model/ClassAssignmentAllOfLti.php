...
/**
 * ClassAssignmentAllOfLti Class Doc Comment
 *
 ...
 */
class ClassAssignmentAllOfLti implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ClassAssignment_allOf_lti';
     ...
     * Sets id
     *
     * @param string|null $id Resource ID in the LMS
     *
     * @return $this
     */
