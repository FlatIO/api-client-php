 ...
 *
 * @description Meta information provided by Canvas LMS
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ClassDetailsCanvas implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ClassDetails_canvas';
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the course on Canvas
     *
     * @return $this
     */
     ...
     * Sets domain
     *
     * @param string|null $domain Canvas instance domain (e.g. \"canvas.instructure.com\")
     *
     * @return $this
     */
