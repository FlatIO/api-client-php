...
class EduResourceCopy implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets destination
     *
     * @param string $destination Unique identifier of the destination folder for the copy. This can also be `root` to copy the resource at the root of the user resource library.
     *
     * @return $this
     */
