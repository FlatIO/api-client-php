...
enum GroupType: string
{
    ...
    case CLASS_STUDENTS_SUB_GROUP = 'classStudentsSubGroup';

    case ASSIGNMENT_STUDENTS_SUB_GROUP = 'assignmentStudentsSubGroup';
}
