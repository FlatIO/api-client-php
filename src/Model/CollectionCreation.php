 ...
 */
class CollectionCreation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CollectionCreation';
    ...
    public function setTitle(?string $title): static
    {
        ...
        if ((mb_strlen($title) > 300)) {
            throw new InvalidArgumentException('invalid length for $title when calling CollectionCreation., must be smaller than or equal to 300.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new InvalidArgumentException('invalid length for $title when calling CollectionCreation., must be bigger than or equal to 1.');
        }
