 ...
 *
 * @description Detected score details for review (the \&quot;Check your score details\&quot; screen). The worker produces &#x60;title&#x60; and &#x60;instruments&#x60; from assembly; the language is not detected and is not part of this payload (the client reads the job&#39;s &#x60;locales&#x60;, set at creation).
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
