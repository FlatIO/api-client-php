...
/**
 * TaskProgress Class Doc Comment
 *
 ...
 */
class TaskProgress implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Task_progress';
     ...
     * Sets percent
     *
     * @param float|null $percent Percent of the task progression
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string|null $text Text details of the task progress
     *
     * @return $this
     */
