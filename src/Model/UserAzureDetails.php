...
/**
 * UserAzureDetails Class Doc Comment
 *
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UserAzureDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'UserAzureDetails';
     ...
     * Sets oid
     *
     * @param string|null $oid User object identifier on Azure AD
     *
     * @return $this
     */
     ...
     * Sets hd
     *
     * @param string|null $hd User tenant (domain name)
     *
     * @return $this
     */
     ...
     *
     * @param string|null $preferred_username User Preferred Username (UPN), i.e. the main email of the user
     *
     * @return $this
     */
    public function setPreferredUsername(?string $preferred_username): static
    {
