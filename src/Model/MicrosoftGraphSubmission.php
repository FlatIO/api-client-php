...
/**
 * MicrosoftGraphSubmission Class Doc Comment
 *
 ...
 */
class MicrosoftGraphSubmission implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MicrosoftGraphSubmission';
     ...
     * Sets id
     *
     * @param string $id Identifier of the submission assigned by Microsoft Teams
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state State of the submission
     *
     * @return $this
     */
