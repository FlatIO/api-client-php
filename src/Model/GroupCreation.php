...
/**
 * GroupCreation Class Doc Comment
 *
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GroupCreation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'GroupCreation';
    ...
    public const TYPE_CLASS_STUDENTS_SUB_GROUP = 'classStudentsSubGroup';
    ...
    {
        return [
            self::TYPE_CLASS_STUDENTS_SUB_GROUP,
        ];
    }
     ...
     * Sets type
     *
     * @param string $type Type of group (currently only classStudentsSubGroup is supported)
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the group (optional - auto-generated if not provided).  **Special names:**  * `edu:testing-students`: Creates a group tagged for test student accounts. The display name will be localized (e.g., \"Test Students\") and the group will be tagged with `edu:testing-students`.
     *
     * @return $this
     */
     ...
     * Sets members
     *
     * @param string[]|null $members Array of student IDs to add to the group
     *
     * @return $this
     */
