...
class Group implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the group
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The display name of the group
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Flat\APIClient\Model\GroupType|null
     */
     ...
     * Sets type
     *
     * @param \Flat\APIClient\Model\GroupType|null $type type
     *
     * @return $this
     */
     ...
     * Sets users_count
     *
     * @param float|null $users_count The number of users in this group
     *
     * @return $this
     */
     ...
     * Sets read_only
     *
     * @param bool|null $read_only `True` if the group is set in read-only
     *
     * @return $this
     */
     ...
     * Sets organization
     *
     * @param string|null $organization If the group is related to an organization, this field will contain the unique identifier of the organization
     *
     * @return $this
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date The creation date of the group
     *
     * @return $this
     */
