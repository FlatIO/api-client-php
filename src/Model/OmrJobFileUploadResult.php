...
/**
 * OmrJobFileUploadResult Class Doc Comment
 *
 * @description Result of adding a file to a draft job.
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class OmrJobFileUploadResult implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'OmrJobFileUploadResult';
    ...
    {
        $this->setIfExists('file_index', $data ?? [], null);
    ...
    {
        return $this->container['file_index'];
    }

    /**
     * Sets file_index
     *
     * @param int|null $file_index 0-based index assigned to the uploaded file.
     *
     * @return $this
     */
    public function setFileIndex(?int $file_index): static
    {
        if (is_null($file_index)) {
            throw new InvalidArgumentException('non-nullable file_index cannot be null');
        }
        $this->container['file_index'] = $file_index;
     ...
     * Sets file_count
     *
     * @param int|null $file_count Total number of files now attached to the job.
     *
     * @return $this
     */
