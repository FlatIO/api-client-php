...
/**
 * CollectionModification Class Doc Comment
 *
 ...
 */
class CollectionModification implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CollectionModification';
     ...
     * Sets title
     *
     * @param string|null $title The title of the collection
     *
     * @return $this
     */
    public function setTitle(?string $title): static
    {
        ...
        if ((mb_strlen($title) > 300)) {
            throw new InvalidArgumentException('invalid length for $title when calling CollectionModification., must be smaller than or equal to 300.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new InvalidArgumentException('invalid length for $title when calling CollectionModification., must be bigger than or equal to 1.');
        }
     ...
     * Gets privacy
     *
     * @return \Flat\APIClient\Model\CollectionPrivacy|null
     */
     ...
     * Sets privacy
     *
     * @param \Flat\APIClient\Model\CollectionPrivacy|null $privacy privacy
     *
     * @return $this
     */
