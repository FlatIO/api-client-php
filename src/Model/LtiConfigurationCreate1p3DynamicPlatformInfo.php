...
/**
 * LtiConfigurationCreate1p3DynamicPlatformInfo Class Doc Comment
 *
 ...
 */
class LtiConfigurationCreate1p3DynamicPlatformInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'LtiConfigurationCreate1p3Dynamic_platformInfo';
     ...
     * Sets name
     *
     * @param string|null $name Platform display name
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string|null $url Optional platform homepage or admin URL for reference
     *
     * @return $this
     */
