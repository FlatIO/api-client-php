...
/**
 * LtiConfiguration1p3BaseSupportedServicesNrps Class Doc Comment
 *
 ...
 */
class LtiConfiguration1p3BaseSupportedServicesNrps implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'LtiConfiguration1p3Base_supportedServices_nrps';
     ...
     * Sets available
     *
     * @param bool|null $available Whether NRPS claims were detected in launches from this platform
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param string|null $version NRPS version supported (e.g., \"2.0\")
     *
     * @return $this
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether we have NRPS enabled for this platform
     *
     * @return $this
     */
