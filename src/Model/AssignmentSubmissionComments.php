...
/**
 * AssignmentSubmissionComments Class Doc Comment
 *
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AssignmentSubmissionComments implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AssignmentSubmission_comments';
     ...
     * Sets total
     *
     * @param float|null $total The total number of comments added to the submission
     *
     * @return $this
     */
     ...
     * @return float|null
     */
    public function getUnread(): ?float
    {
     ...
     * Sets unread
     *
     * @param float|null $unread The number of unread comments for the current user
     *
     * @return $this
     */
    public function setUnread(?float $unread): static
    {
        if (is_null($unread)) {
