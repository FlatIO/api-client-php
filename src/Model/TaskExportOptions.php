...
/**
 * TaskExportOptions Class Doc Comment
 *
 * @description Options for the requested export
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class TaskExportOptions implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'TaskExportOptions';
     ...
     * Sets parts
     *
     * @param string[]|null $parts A list of parts to specifically export
     *
     * @return $this
     */
