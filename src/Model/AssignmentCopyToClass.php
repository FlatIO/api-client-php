...
/**
 * AssignmentCopyToClass Class Doc Comment
 *
 ...
 */
class AssignmentCopyToClass implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AssignmentCopyToClass';
     ...
     * Sets classroom
     *
     * @param string $classroom The destination classroom where the assignment will be copied
     *
     * @return $this
     */
     ...
     * Sets assignment
     *
     * @param string|null $assignment An optional destination assignment where the original assignement will be copied. Must be a draft.
     *
     * @return $this
     */
     ...
     * Sets scheduled_date
     *
     * @param \DateTime|null $scheduled_date The publication (scheduled) date of the assignment. If this one is specified, the assignment will only be listed to the teachers of the class. Alternatively the existing `scheduledDate` from the copied assignment will be used.
     *
     * @return $this
     */
