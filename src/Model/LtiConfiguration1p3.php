...
/**
 * LtiConfiguration1p3 Class Doc Comment
 *
 * @description LTI 1.3 configuration details
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class LtiConfiguration1p3 implements OneOfInterface
{
    /**
     ...
     * @var string
     */
    public const MODEL_NAME = 'LtiConfiguration1p3';
    ...
    {
        return [
            '\Flat\APIClient\Model\LtiConfiguration1p3Manual',
            '\Flat\APIClient\Model\LtiConfiguration1p3Deployment',
            '\Flat\APIClient\Model\LtiConfiguration1p3Dynamic'
        ];
    }
