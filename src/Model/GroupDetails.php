...
class GroupDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets classroom
     *
     * @param string|null $classroom The unique identifier of the classroom owning the group. Only available for groups of type 'classStudentsSubGroup' or 'assignmentStudentsSubGroup'
     *
     * @return $this
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime $creation_date The date when the group was created
     *
     * @return $this
     */
     ...
     * Sets read_only
     *
     * @param bool $read_only `true` if the properties and members of this group are read-only
     *
     * @return $this
     */
