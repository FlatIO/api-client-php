...
/**
 * LtiConfiguration Class Doc Comment
 *
 ...
 * @link     https://openapi-generator.tech
 */
class LtiConfiguration implements OneOfInterface
{
    /**
     ...
     * @var string
     */
    public const MODEL_NAME = 'LtiConfiguration';
     ...
     * @var string|null
     */
    public const DISCRIMINATOR = 'ltiVersion';
    ...
    {
        return [
            '\Flat\APIClient\Model\LtiConfiguration1p1',
            '\Flat\APIClient\Model\LtiConfiguration1p3'
        ];
    }
    ...
    {
        return [
            '1p1' => '\Flat\APIClient\Model\LtiConfiguration1p1',
            '1p3' => '\Flat\APIClient\Model\LtiConfiguration1p3'
        ];
    }
}
