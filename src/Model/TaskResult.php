...
class TaskResult implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Task_result';
     ...
     * Sets url
     *
     * @param string|null $url URL of the generated file, when the task produces one
     *
     * @return $this
     */
     ...
     * Sets error
     *
     * @param string|null $error Error message, when the task failed
     *
     * @return $this
     */
