...
/**
 * EduResourceUseInClass Class Doc Comment
 *
 ...
 */
class EduResourceUseInClass implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'EduResourceUseInClass';
     ...
     * Sets classroom
     *
     * @param string $classroom The destination classroom where the resource will be copied.
     *
     * @return $this
     */
