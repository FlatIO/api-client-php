...
/**
 * LtiConfigurationCreate1p3Deployment Class Doc Comment
 *
 ...
 */
class LtiConfigurationCreate1p3Deployment implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'LtiConfigurationCreate1p3Deployment';
     ...
     * Sets mode
     *
     * @param string $mode LTI 1.3 deployment-based creation mode
     *
     * @return $this
     */
     ...
     *
     * @param string $deployment_type Parent platform key (e.g., blackboard, schoology, classlink, manabipocket, manabipocket-stg)
     *
     * @return $this
     */
    public function setDeploymentType(string $deployment_type): static
    {
     ...
     * Sets deployment_id
     *
     * @param string $deployment_id Deployment identifier provided by the platform
     *
     * @return $this
     */
     ...
     * Sets client_id
     *
     * @param string|null $client_id OAuth2 client_id for the tenant; required for ClassLink deployments
     *
     * @return $this
     */
     ...
     *
     * @param string|null $deployment_breakdown_id Value of the custom claim that identifies this specific tenant (for multi-tenant platforms like Schoology)
     *
     * @return $this
     */
