 ...
 *
 * @description A computed version of the total, unique, weekly, monthly and yearly number of comments added on the documents (this doesn&#39;t include inline comments).
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ScoreCommentsCounts implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ScoreCommentsCounts';
     ...
     * Sets total
     *
     * @param float|null $total The total number of comments added to the score
     *
     * @return $this
     */
     ...
     * Sets unique
     *
     * @param float|null $unique The unique (1/user) number of comments added to the score
     *
     * @return $this
     */
    public function setUnique(?float $unique): static
    {
        if (is_null($unique)) {
     ...
     * Sets weekly
     *
     * @param float|null $weekly The weekly unique number of comments added to the score
     *
     * @return $this
     */
     ...
     * Sets monthly
     *
     * @param float|null $monthly The monthly unique number of comments added to the score
     *
     * @return $this
     */
     ...
     * Sets yearly
     *
     * @param float|null $yearly The yearly unique number of comments added to the score
     *
     * @return $this
     */
