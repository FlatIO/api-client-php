 ...
 */
class EduLibrary implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'EduLibrary';
    ...
    public const TYPE_MY_RESOURCES = 'myResources';
    public const TYPE_ORGANIZATION_RESOURCES = 'organizationResources';
    public const TYPE_FLAT_EDU_CONTENT = 'flatEduContent';
    ...
    {
        return [
            self::TYPE_MY_RESOURCES,
            self::TYPE_ORGANIZATION_RESOURCES,
            self::TYPE_FLAT_EDU_CONTENT,
        ];
    }
     ...
     * @return string[]
     */
    public static function getVisibilityAllowableValues()
    {
        return [
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getVisibilityAllowableValues();
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the library.  This one can be used to list the underlying resources using `GET /v2/eduResources?parent={library-id}`
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the lirbary
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of the library
     *
     * @return $this
     */
     ...
     * Sets visibility
     *
     * @param string $visibility Visibility of the library
     *
     * @return $this
     */
