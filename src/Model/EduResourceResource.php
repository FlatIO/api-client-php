...
/**
 * EduResourceResource Class Doc Comment
 *
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class EduResourceResource implements OneOfInterface
{
    /**
     ...
     * @var string
     */
    public const MODEL_NAME = 'EduResource_resource';
    ...
    public static function getOneOfTypes(): array
    {
        return [
            ...
            '\Flat\APIClient\Model\EduResourceFolder'
        ];
    }
