...
/**
 * OmrJobProgress Class Doc Comment
 *
 * @description Live progress while the job is processing.
 * @package  Flat\APIClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class OmrJobProgress implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'OmrJobProgress';
     ...
     * Sets percent
     *
     * @param float|null $percent Completion percentage (0-100).
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string|null $text Localized progress message, ready to display.
     *
     * @return $this
     */
     ...
     * Sets key
     *
     * @param string|null $key Stable progress key (for example `OMR_QUEUED`, `OMR_PROCESSING_PAGE`, `OMR_CREATING_SCORE`), for matching the current phase in a stepper UI independent of locale.
     *
     * @return $this
     */
