...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.flat.io/v2';
     ...
     * @var string
     */
    protected string $userAgent = 'Flat-SDK-PHP/1.0.0 (php/' . PHP_VERSION . ')';
    ...
    public static function toDebugReport(): string
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.26.2' . PHP_EOL;
