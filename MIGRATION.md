...
release line (0.6.x) was generated in 2024 or earlier and is missing everything the API has
shipped since.

The previous major stays installable and is deprecated on Packagist, not withdrawn. Nothing breaks
...
3. **Supported runtimes moved up** to PHP 8.2, 8.3 and 8.4. End-of-life runtimes are no longer supported.
...
2. Bump the dependency: `composer require flat/api`.
