...
**mode** | **string** | Deployment-based LTI 1.3 configuration mode | [optional]
...
**parent_id** | **string** | Parent configuration ID (for deployment-based configs) | [optional]
**deployment_key** | **string** | Deployment key (e.g., schoology, classlink) | [optional]
**deployment_breakdown_by** | **string** | Custom claim used for tenant identification (parent platforms only, read-only) | [optional]
**deployment_breakdown_id** | **string** | Value of the custom claim that identifies this specific tenant (child platforms only) | [optional]
