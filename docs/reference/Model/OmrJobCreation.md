...
**locales** | **string[]** | Locale hints (BCP 47) to improve text and lyric detection, for example &#x60;[\&quot;ja\&quot;, \&quot;en\&quot;]&#x60;. The first entry is the primary reading language. This is the input hint; the main language can be confirmed or corrected at the &#x60;details&#x60; step. | [optional]
