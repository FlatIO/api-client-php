...
**mode** | **string** | Dynamic registration LTI 1.3 configuration mode | [optional]
...
**registration_token** | **string** | Only included for admins | [optional]
**registration_url** | **string** | Dynamic registration URL (only included for admins when available) | [optional]
